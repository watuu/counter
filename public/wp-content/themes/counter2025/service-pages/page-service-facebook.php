<?php
/**
 * Template Name: Facebook広告運用代行サービスのテンプレート
 */
...
<p></p>
<main>
  <div class="service-facebook container">
    <div class="service-facebook-inner">
      <div class="service-facebook-fv">
        <div class="service-facebook-fv__inner service-facebook-inner">
          <div class="content">
            <div class="content__inner">
              <p class="content__lead utils-block-hidden-mobile">
                <span>Facebook広告の運用でお悩みの方へ</span>
              </p>
              <p class="content__lead utils-block-hidden-pc">
                <span>Facebook広告の運用で</span><br>
                <span>お悩みの方へ</span>
              </p>
              ...
              <p class="content__text">Facebook広告の運用経験豊富なコンサルタントが監修するサービスです。</p>
            </div>
            <div class="content__inner">
              <ul class="content__list">
                <li class="content__item"><a class="service-facebook-btn service-facebook-btn--orange" href="https://counter-digital.jp/download<?php echo $document_slug; ?>/">無料で資料ダウンロード</a></li>
                <li class="content__item"><a class="service-facebook-btn service-facebook-btn--black" href="#contact">無料で相談する</a></li>
              </ul>
            </div>
          </div>
      ...
      <section class="service-facebook-problems">
        <div class="service-facebook-problems__inner service-facebook-inner">
          <h2 class="introduction">Facebook広告の運用<br class="utils-block-hidden-pc">に関する<br>こんな<span>お</span><span>悩</span><span>み</span>はありませんか？</h2>
          <?php
          // サービス内容のデータを配列として管理
          $service_seo_list = [
            [
              'label' => '1',
              'heading' => ['Facebook広告に関する', 'ノウハウがない'],
              'text' => '広告の運用方法がわからず、設定方法や運用中の改善ポイントがわからず、自社で進められない状態になっている。'
            ],
            [
              'label' => '2',
              'heading' => ['Facebook広告の', '運用計画が立てられない'],
              'text' => 'Facebook広告の商材別CPA単価がわからず、費用対効果がある運用計画を立てられていない。'
            ],
            [
              'label' => '3',
            ...
            [
              ...
              'text' => 'Facebook広告の運用ノウハウはあるけれど、出稿管理運用改善を行える人材が社内にいない。'
            ],
            [
              'label' => '6',
              'heading' => ['広告運用とCROを', '同時に行いたい'],
              'text' => 'Facebook広告の運用改善に加え、CVR改善を行える企業を探している。'
            ],
          ];
          ?>
          <ol class="service-facebook-list service-facebook-list--col003 js-scroll-anime" data-anime="fadeInUp">
            <?php foreach ($service_seo_list as $service): ?>
              <li class="service-facebook-list__item">
                <section class="service-facebook-card001">
                  <p class="service-facebook-card001__label"><?php echo esc_html($service['label']); ?></p>
                  <div class="service-facebook-card001__inner">
                    <h3 class="service-facebook-card001__heading">
                      <?php foreach ($service['heading'] as $heading): ?>
                        <span><?php echo esc_html($heading); ?></span><br>
                      <?php endforeach; ?>
                    </h3>
                    <p class="service-facebook-card001__text"><?php echo esc_html($service['text']); ?></p>
                  </div>
                </section>
              </li>
            <?php endforeach; ?>
          ...
          <div class="solution js-scroll-anime" data-anime="fadeInUp">
            <p class="solution__text solution__text--sub">COUNTER(カウンター)の<br class="utils-block-hidden-pc">Facebook広告運用代行サービスで</p>
            <p class="solution__text solution__text--main"><span>全て<span>解</span><span>決</span>できます!!</span></p>
          </div>
        </div>
      </div>

      <?php get_template_part('template-parts/service-facebook-cta') ?>

      <section class="service-facebook-points">
        <div class="service-facebook-points__inner service-facebook-inner">
          <div class="service-facebook-heading">
            <h2 class="service-facebook-heading__main"><span>カウンターの6つの強み</span></h2>
            <p class="service-facebook-heading__lead">カウンターだからこそできる<br>Facebook広告運用代行サービスの<br class="utils-block-hidden-pc">6つの強みをご紹介いたします。</p>
          </div>
          <?php
          // サービス内容のデータを配列として管理
          $service_seo_list = [
            [
              'label' => '1',
              'heading' => ['Facebook広告の豊富な', '実績のあるプロが担当'],
              'text' => '効果改善率95%のプロの運用担当者がご支援いたします。再現性の高い広告施策をご提案いたします。'
            ],
            [
              'label' => '2',
              'heading' => ['プランニングから実行支援まで', 'トータル支援'],
              'text' => 'Facebook広告の広告計画から入稿作業、調整業務などを一気通貫でサポートいたします。'
            ],
            [
              'label' => '3',
              'heading' => ['Facebook広告に関する', '高い専門性'],
              'text' => 'Facebook広告のアルゴリズムを理解したプロの運用担当者がお客様の商材に合わせて運用いたします。インスタグラムのアップデート情報も随時ご共有いたします。'
            ],
            [
              'label' => '4',
            ...
            [
              ...
              'text' => '自社でFacebook広告運用を行いたい企業様向けにインハウス支援のサービスも行っております。インハウス運用までのロードマップを策定し、伴走支援を行います。'
            ],
            [
              'label' => '6',
              'heading' => ['Facebook広告運用', '以外にもCROや', 'ホワイトペーパー制作もできる'],
              'text' => 'Facebook広告運用だけでなく、CVR改善(CRO)やホワイトペーパー制作などの領域も対応可能です。'
            ],
          ];
          ?>
              ...
              <li class="service-facebook-list__item">
                <section class="service-facebook-card001">
                  ...
                  <div class="service-facebook-card001__inner">
                    ...
                    <p class="service-facebook-card001__text"><?php echo wp_kses_post($service['text']); ?></p>
                  </div>
                </section>
              </li>
            <?php endforeach; ?>
      ...
      <section class="service-facebook-service">
        <div class="service-facebook-service__inner service-facebook-inner">
          <div class="service-facebook-heading">
            <p class="service-facebook-heading__sub">カウンターの</p>
            <h2 class="service-facebook-heading__main"><span>Facebook広告運用<br class="utils-block-hidden-pc">代行サービス</span></h2>
            <p class="service-facebook-heading__lead">実績豊富な担当者が運用代行を行います。</p>
          </div>
                ...
                <div class="table__body">
                  <ul class="table__list">
                    ...
                    <li class="table__item">
                      ...
                      <p class="table__text">Facebook広告に関する課題感やスケジュール等をCOUNTERの担当営業からヒアリングさせていただきます。</p>
                    </li>
                    <li class="table__item">
                ...
                <div class="table__body">
                  <ul class="table__list">
                    <li class="table__item">
                      ...
                      <p class="table__text">COUNTERのコンサルタントがFacebook広告の戦略策定を行います。</p>
                    </li>
                    <li class="table__item">
                      <p class="table__label">準備</p>
                      <p class="table__text">Facebook広告アカウント情報をご共有いただき、キャンペーン設定を行います。</p>
                    </li>
                  </ul>
                </div>
              </section>
                ...
                <div class="table__body">
                  <ul class="table__list">
                    <li class="table__item">
                      ...
                      <p class="table__text">Facebook広告の戦略をもとに運用を行い、各種施策を進めてまいります。</p>
                    </li>
                    <li class="table__item">
      ...
      <section class="service-facebook-differ">
        <div class="service-facebook-heading">
          <h2 class="service-facebook-heading__main"><span>他社との違い</span></h2>
        </div>
        <div class="service-facebook-differ__inner service-facebook-inner">
      ...
      <section class="service-facebook-ceo">
        <div class="service-facebook-ceo__inner service-facebook-inner">
          <section class="swiper js-pickup-slider-single">
            <ul class="swiper-wrapper">
              <li class="swiper-slide">
                <div class="service-facebook-ceo__box js-scroll-anime" data-anime="fadeInUp">
                  <div class="service-facebook-heading">
                    <h2 class="service-facebook-heading__main"><span>Facebook広告運用代行<br class="utils-block-hidden-pc">サービスの担当者ご紹介</span></h2>
                  </div>
                  <div class="content">
      ...
      <section class="service-facebook-qa">
        <div class="service-facebook-qa__inner service-facebook-inner">
          <div class="service-facebook-heading">
            <p class="service-facebook-heading__sub">Facebook広告運用代行サービスでの</p>
            <h2 class="service-facebook-heading__main"><span>よくある質問</span></h2>
          </div>
          <?php
          // リストデータを配列で管理
          $list_items = [
            ...
            [
              'question' => 'Facebook広告を運用するために必要な準備はどのようなものがありますか？',
              'answer' => 'Facebookアカウントの開設、広告用クリエイティブの準備が必要となります。'
            ],
            [
                  ...
                  <div class="content__body <?php echo $index === 0 ? 'utils-active' : ''; ?>">
                    <div class="content__inner">
                      ...
                      <div class="content__btn" style="margin-top:38px;">
                        <a class="service-facebook-btn service-facebook-btn--black" href="#contact">無料で相談する</a>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="section contact" id="contact" data-scroll-adjust-pc="60" data-scroll-adjust-sp="30">
        <div class="service-facebook-heading">
          <h2 class="service-facebook-heading__main"><span>お問い合わせ</span></h2>
        </div>
        <div class="inner-s">
        ...
        <script>
          document.addEventListener('DOMContentLoaded', function() {
            document.querySelector('.contact-form__input#service').value = "Facebook広告運用代行";
