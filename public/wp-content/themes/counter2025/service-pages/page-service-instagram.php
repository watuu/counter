<?php
/**
 * Template Name: Instagram広告運用代行サービスのテンプレート
 */
...
// CTAセクションを表示する関数を定義
function display_service_instagram_cta() {
  ?>
  <section class="service-instagram-cta">
    <div class="service-instagram-cta__inner service-instagram-inner">
      <div class="content">
        <p class="content__lead"><span>実績豊富な広告運用のプロが対応します</span></p>
        <p class="content__heading"><span> Instagram広告の運用強化</span><br>でお悩みの方<br>お気軽にご相談ください!!</p>
        <p class="content__text">実績豊富な運用担当者が、<br class="utils-block-hidden-pc">課題に応じて、<br class="utils-block-hidden-pc">Instagram広告の運用を支援します。<br>Instagram広告の運用代行は<br class="utils-block-hidden-pc">COUNTER(カウンター)へご相談ください。</p>
        ...
        <ul class="content__list">
          <li class="content__item"><a class="service-instagram-btn service-instagram-btn--orange service-instagram-btn--white" href="https://counter-digital.jp/download/document-company/">無料で資料ダウンロード</a></li>
          <li class="content__item"><a class="service-instagram-btn service-instagram-btn--white" href="#contact">無料で相談する</a></li>
        </ul>
      </div>
    </div>
  </section>
...
<p></p>
<main>
  <div class="service-instagram container">
    <div class="service-instagram-inner">
      <div class="service-instagram-fv">
        <div class="service-instagram-fv__inner service-instagram-inner">
          <div class="content">
            <div class="content__inner">
              <p class="content__lead utils-block-hidden-mobile">
                <span>Instagram広告の運用でお悩みの方へ</span>
              </p>
              <p class="content__lead utils-block-hidden-pc">
                <span>Instagram広告の運用で</span><br>
                <span>お悩みの方へ</span>
              </p>
              <h1 class="content__heading">
                <span>Instagram広告</span><span>運用代行サービス</span>
              </h1>
              <p class="content__text">Instagram広告の運用経験豊富なコンサルタントが監修するサービスです。</p>
            </div>
            <div class="content__inner">
              <ul class="content__list">
                <li class="content__item"><a class="service-instagram-btn service-instagram-btn--orange" href="https://counter-digital.jp/download<?php echo $document_slug; ?>/">無料で資料ダウンロード</a></li>
                <li class="content__item"><a class="service-instagram-btn service-instagram-btn--black" href="#contact">無料で相談する</a></li>
              </ul>
            </div>
          </div>
      ...
      <section class="service-instagram-problems">
        <div class="service-instagram-problems__inner service-instagram-inner">
          <h2 class="introduction">Instagram広告運用<br class="utils-block-hidden-pc">に関する<br>こんな<span>お</span><span>悩</span><span>み</span>はありませんか？</h2>
          <?php
          // サービス内容のデータを配列として管理
          $service_seo_list = [
            [
              'label' => '1',
              'heading' => ['Instagram広告に関する', 'ノウハウがない'],
              'text' => '広告の運用方法がわからず、設定方法や運用中の改善ポイントがわからず、自社で進められない状態になっている。'
            ],
            [
              'label' => '2',
              'heading' => ['Instagram広告の', '運用計画が立てられない'],
              'text' => 'Instagram広告の商材別CPA単価がわからず、費用対効果がある運用計画を立てたい。'
            ],
            [
              'label' => '3',
            ...
            [
              ...
              'text' => 'Instagram広告の運用ノウハウはあるけれど、出稿管理運用改善を行える人材が社内にいない。'
            ],
            [
              'label' => '6',
              'heading' => ['広告運用とCROを', '同時に行いたい'],
              'text' => 'Instagram広告の運用改善に加え、CVR改善を行える企業を探している。'
            ],
          ];
          ?>
          <ol class="service-instagram-list service-instagram-list--col003 js-scroll-anime" data-anime="fadeInUp">
            <?php foreach ($service_seo_list as $service): ?>
              <li class="service-instagram-list__item">
                <section class="service-instagram-card001">
                  <p class="service-instagram-card001__label"><?php echo esc_html($service['label']); ?></p>
                  <div class="service-instagram-card001__inner">
                    <h3 class="service-instagram-card001__heading">
                      <?php foreach ($service['heading'] as $heading): ?>
                        <span><?php echo esc_html($heading); ?></span><br>
                      <?php endforeach; ?>
                    </h3>
                    <p class="service-instagram-card001__text"><?php echo esc_html($service['text']); ?></p>
                  </div>
                </section>
              </li>
            <?php endforeach; ?>
          ...
          <div class="solution js-scroll-anime" data-anime="fadeInUp">
            <p class="solution__text solution__text--sub">COUNTER(カウンター)の<br class="utils-block-hidden-pc">Instagram広告運用代行サービスで</p>
            <p class="solution__text solution__text--main"><span>全て<span>解</span><span>決</span>できます!!</span></p>
          </div>
        </div>
      </div>

      <?php display_service_instagram_cta(); ?>

      <section class="service-instagram-points">
        <div class="service-instagram-points__inner service-instagram-inner">
          <div class="service-instagram-heading">
            <h2 class="service-instagram-heading__main"><span>カウンターの6つの強み</span></h2>
            <p class="service-instagram-heading__lead">カウンターだからこそできる<br>Instagram広告運用代行サービスの<br class="utils-block-hidden-pc">6つの強みをご紹介いたします。</p>
          </div>
          <?php
          // サービス内容のデータを配列として管理
          $service_instagram_list = [
            [
              'label' => '1',
              'heading' => ['Instagram広告の豊富な', '実績のあるプロが担当'],
              'text' => '効果改善率95%のプロの運用担当者がご支援いたします。再現性の高い広告施策をご提案いたします。'
            ],
            [
              'label' => '2',
              'heading' => ['プランニングから実行支援まで', 'トータル支援'],
              'text' => 'Instagram広告の広告計画から入稿作業、調整業務などを一気通貫でサポートいたします。'
            ],
            [
              'label' => '3',
              'heading' => ['Instagram広告に関する', '高い専門性'],
              'text' => 'Instagram広告のアルゴリズムを理解したプロの運用担当者がお客様の商材に合わせて運用いたします。インスタグラムのアップデート情報も随時ご共有いたします。'
            ],
            [
              'label' => '4',
            ...
            [
              ...
              'text' => '自社でInstagram広告運用を行いたい企業様向けにインハウス支援のサービスも行っております。インハウス運用までのロードマップを策定し、伴走支援を行います。'
            ],
            [
              'label' => '6',
              'heading' => ['Instagram広告運用', '以外にもCROや', 'ホワイトペーパー制作もできる'],
              'text' => 'Instagram広告運用だけでなく、CVR改善(CRO)やホワイトペーパー制作などの領域も対応可能です。'
            ],
          ];
          ?>

          <ol class="service-instagram-list service-instagram-list--col003 js-scroll-anime" data-anime="fadeInUp">
            <?php foreach ($service_instagram_list as $service): ?>
              <li class="service-instagram-list__item">
                <section class="service-instagram-card001">
                  <p class="service-instagram-card001__label"><?php echo esc_html($service['label']); ?></p>
                  <div class="service-instagram-card001__inner">
                    ...
                    <p class="service-instagram-card001__text"><?php echo wp_kses_post($service['text']); ?></p>
                  </div>
                </section>
              </li>
            <?php endforeach; ?>
      ...
      <section class="service-instagram-service">
        <div class="service-instagram-service__inner service-instagram-inner">
          <div class="service-instagram-heading">
            <p class="service-instagram-heading__sub">カウンターの</p>
            <h2 class="service-instagram-heading__main"><span>Instagram広告運用<br class="utils-block-hidden-pc">代行サービス</span></h2>
            <p class="service-instagram-heading__lead">実績豊富な担当者が運用代行を行います。</p>
          </div>
                ...
                <div class="table__body">
                  <ul class="table__list">
                    ...
                    <li class="table__item">
                      ...
                      <p class="table__text">Instagram広告に関する課題感やスケジュール等をCOUNTERの担当営業からヒアリングさせていただきます。</p>
                    </li>
                    <li class="table__item">
                ...
                <div class="table__body">
                  <ul class="table__list">
                    <li class="table__item">
                      ...
                      <p class="table__text">COUNTERのコンサルタントがInstagram広告の戦略策定を行います。</p>
                    </li>
                    <li class="table__item">
                      <p class="table__label">準備</p>
                      <p class="table__text">Instagram広告アカウント情報をご共有いただき、キャンペーン設定を行います。</p>
                    </li>
                  </ul>
                </div>
              </section>
                ...
                <div class="table__body">
                  <ul class="table__list">
                    <li class="table__item">
                      ...
                      <p class="table__text">Instagram広告の戦略をもとに運用を行い、各種施策を進めてまいります。</p>
                    </li>
                    <li class="table__item">
      ...
      <section class="service-instagram-differ">
        <div class="service-instagram-heading">
          <h2 class="service-instagram-heading__main"><span>他社との違い</span></h2>
        </div>
        <div class="service-instagram-differ__inner service-instagram-inner">
      ...
      <section class="service-instagram-ceo">
        <div class="service-instagram-ceo__inner service-instagram-inner">
          <section class="swiper js-pickup-slider-single">
            <ul class="swiper-wrapper">
              <li class="swiper-slide">
                <div class="service-instagram-ceo__box js-scroll-anime" data-anime="fadeInUp">
                  <div class="service-instagram-heading">
                    <h2 class="service-instagram-heading__main"><span>Instagram広告運用代行<br class="utils-block-hidden-pc">サービスの担当者ご紹介</span></h2>
                  </div>
                  <div class="content">
      ...
      <section class="service-instagram-qa">
        <div class="service-instagram-qa__inner service-instagram-inner">
          <div class="service-instagram-heading">
            <p class="service-instagram-heading__sub">Instagram広告運用代行サービスでの</p>
            <h2 class="service-instagram-heading__main"><span>よくある質問</span></h2>
          </div>
          <?php
          // リストデータを配列で管理
          $list_items = [
            ...
            [
              'question' => 'Instagram広告を運用するために必要な準備はどのようなものがありますか？',
              'answer' => 'Instagramアカウントの開設、広告用クリエイティブの準備が必要となります。'
            ],
            [
                  ...
                  <div class="content__body <?php echo $index === 0 ? 'utils-active' : ''; ?>">
                    <div class="content__inner">
                      ...
                      <div class="content__btn" style="margin-top:38px;">
                        <a class="service-instagram-btn service-instagram-btn--black" href="#contact">無料で相談する</a>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="section contact" id="contact" data-scroll-adjust-pc="60" data-scroll-adjust-sp="30">
        <div class="service-instagram-heading">
          <h2 class="service-instagram-heading__main"><span>お問い合わせ</span></h2>
        </div>
        <div class="inner-s">
        ...
        <script>
          document.addEventListener('DOMContentLoaded', function() {
            document.querySelector('.contact-form__input#service').value = "Instagram広告運用代行";
