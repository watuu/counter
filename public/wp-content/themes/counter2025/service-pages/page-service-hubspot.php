<?php
/**
 * Template Name: HubSpot導入支援/運用代行サービスのテンプレート
 */
...
<main>
  <div class="service-hubspot container">
    <div class="service-hubspot-inner">
      <div class="service-hubspot-fv">
        <div class="service-hubspot-fv__inner service-hubspot-inner">
          <div class="content">
            <div class="content__inner">
              <p class="content__lead utils-block-hidden-pc">
                <span>HubSpotの導入、運用で</span><br>
                <span>お悩みの方へ&nbsp;</span>
              </p>
              <p class="content__lead utils-block-hidden-mobile">
                <span>HubSpotの導入、運用でお悩みの方へ&nbsp;</span>
              </p>
              <h1 class="content__heading">
                <span>HubSpot導入支援/</span><span>運用代行サービス</span>
              </h1>
              <p class="content__text utils-block-hidden-mobile">HubSpotの導入・運用経験豊富なコンサルタントが監修する<br>HubSpotの運用と強化を目的とした導入支援/運用代行サービスです。</p>
              <p class="content__text utils-block-hidden-pc">HubSpotの導入・運用経験豊富なコンサルタントが監修するHubSpotの運用と強化を目的とした導入支援/運用代行サービスです。</p>
            </div>
            <div class="content__inner">
              <ul class="content__list">
                <li class="content__item"><a class="service-hubspot-btn service-hubspot-btn--orange" href="https://counter-digital.jp/download<?php echo $document_slug; ?>/">無料で資料ダウンロード</a></li>
                <li class="content__item"><a class="service-hubspot-btn service-hubspot-btn--black" href="#contact">無料で相談する</a></li>
              </ul>
            </div>
          </div>
      ...
      <section class="service-hubspot-problems">
        <div class="service-hubspot-problems__inner service-hubspot-inner">
          <h2 class="introduction">HubSpotの<br class="utils-block-hidden-pc">運用と活用に関する<br>こんな<span>お</span><span>悩</span><span>み</span>はありませんか？</h2>
          <?php
          // サービス内容のデータを配列として管理
          $service_seo_list = [
            [
              'label' => '1',
              'heading' => ['HubSpotのノウハウがない'],
              'text' => 'HubSpotを導入し、デジタル化・DXを進めたいが、ノウハウが少なく、導入後の変化が理解しきれない。'
            ],
            [
              'label' => '2',
              'heading' => ['HubSpotの運用人財が乏しい'],
              'text' => '自社でHubSpotの運用を実施したいけれど、IT人財が乏しい、または退職により自社での運用が難しい。'
            ],
            [
              'label' => '3',
              'heading' => ['HubSpotの構築が進まない'],
              'text' => 'HubSpotをさらに活用したいけれど、業務プロセスに沿った構築ができない。'
            ],
            [
              'label' => '4',
              'heading' => ['HubSpotを活用できていない'],
              'text' => '初期構築を外部業者に委託したけれど、構築後の運用まで伴走してもらえず、活用できていない。'
            ],
            [
              'label' => '5',
              'heading' => ['どの業者が良いのかわからない'],
              'text' => '初期構築、伴走支援、運用代行などの様々な領域がある中で、どの業者に依頼するのが良いのかわからず依頼先を決めづらい。'
            ],
            [
              'label' => '6',
              'heading' => ['HubSpotの', 'コンサルティングを', '依頼しているが変化が見えない'],
              'text' => 'すでにHubSpotを外部業者に依頼しているが成果が出ておらず、困っている。'
            ],
          ];
          ?>
          <ol class="service-hubspot-list service-hubspot-list--col003 js-scroll-anime" data-anime="fadeInUp">
            <?php foreach ($service_seo_list as $service): ?>
              <li class="service-hubspot-list__item">
                <section class="service-hubspot-card001">
                  <p class="service-hubspot-card001__label"><?php echo esc_html($service['label']); ?></p>
                  <div class="service-hubspot-card001__inner">
                    <h3 class="service-hubspot-card001__heading">
                      <?php foreach ($service['heading'] as $heading): ?><span><?php echo esc_html($heading); ?></span><br><?php endforeach; ?>
                    </h3>
                    <p class="service-hubspot-card001__text"><?php echo esc_html($service['text']); ?></p>
                  </div>
                </section>
              </li>
            <?php endforeach; ?>
          ...
          <div class="solution js-scroll-anime" data-anime="fadeInUp">
            <p class="solution__text solution__text--sub">COUNTER(カウンター)の<br class="utils-block-hidden-pc">HubSpot導入支援/運用代行<br class="utils-block-hidden-pc">サービスで</p>
            <p class="solution__text solution__text--main"><span>全て<span>解</span><span>決</span>できます!!</span></p>
          </div>
        </div>
      </div>

      <?php get_template_part('template-parts/service-hubspot-cta') ?>

      <section class="service-hubspot-points">
        <div class="service-hubspot-points__inner service-hubspot-inner">
          <div class="service-hubspot-heading">
            <h2 class="service-hubspot-heading__main"><span>カウンターの6つの強み</span></h2>
            <p class="service-hubspot-heading__lead">カウンターだからこそできる<br>HubSpot導入支援/運用代行サービスの<br class="utils-block-hidden-pc">6つの強みをご紹介いたします。</p>
          </div>
          <?php
          // サービス内容のデータを配列として管理
          $service_seo_list = [
            [
              'label' => '1',
              'heading' => ['HubSpotの運用経験豊富な', 'コンサルタントが対応'],
              'text' => '卓越したHubSpot導入事例として選ばれたプロが、導入検討から活用支援まで対応します。'
            ],
            [
              'label' => '2',
              'heading' => ['活用策定から実行までの', 'トータル支援'],
              'text' => 'HubSpotの活用策定から実行支援までトータル支援が可能です。営業日報や商談・案件管理の活用策定、業務プロセスに沿った個別での対応も可能です。'
            ],
            [
              'label' => '3',
              'heading' => ['HubSpotに関する', '高い専門性'],
              'text' => 'COUNTERでは、HubSpot運用経験豊富なプロのコンサルタントが対応します。多くの業界、活用事例に基づいたHubSpotの運用支援を行います。'
            ],
            [
              'label' => '4',
            ...
            [
              'label' => '5',
              'heading' => ['HubSpot活用診断も提供'],
              'text' => '既存のHubSpot運用の良し悪しについて評価するサービスもご提供可能です。通常料金よりもお求めやすい価格となっておりますので、ご検討ください。'
            ],
            [
              'label' => '6',
              ...
              <li class="service-hubspot-list__item">
                <section class="service-hubspot-card001">
                  ...
                  <div class="service-hubspot-card001__inner">
                    ...
                    <p class="service-hubspot-card001__text"><?php echo wp_kses_post($service['text']); ?></p>
                  </div>
                </section>
              </li>
            <?php endforeach; ?>
      ...
      <section class="service-hubspot-service">
        <div class="service-hubspot-service__inner service-hubspot-inner">
          <div class="service-hubspot-heading">
            <p class="service-hubspot-heading__sub">カウンターの</p>
            <h2 class="service-hubspot-heading__main"><span>HubSpot導入支援/運用代行<br class="utils-block-hidden-pc">サービス</span></h2>
            <p class="service-hubspot-heading__lead">マーケティングの実績が<br class="utils-block-hidden-pc">豊富な担当者が運用代行を行います。</p>
          </div>
          <div class="table js-scroll-anime" data-anime="fadeInUp">
            <div class="table__inner">
              <section class="table__group">
                <div class="table__head">
                  <div class="table__block">
                    <h3 class="table__heading">HubSpot設計フェーズ</h3>
                ...
                <div class="table__body">
                  <ul class="table__list">
                    <li class="table__item">
                      ...
                      <p class="table__text">HubSpotの特性を理解した上で目的や現在の課題、業務プロセスなどをヒアリングさせていただきます。導入検討時の既存データ構造や営業プロセス、事業概要も合わせてキャッチアップいたします。</p>
                    </li>
                    <li class="table__item">
                      <p class="table__label">プロセス策定</p>
                      <p class="table__text">ヒアリングを受け、貴社のデータ構造や営業プロセス、HubSpot導入後の理想像から、営業・業務プロセスの整理と策定を行います。</p>
                    </li>
                    <li class="table__item">
                      <p class="table__label">HubSpot要件定義</p>
                      <p class="table__text">ヒアリング、プロセス策定をもとにカウンターの担当者がHubSpotの設計を行います。</p>
                    </li>
                  </ul>
                </div>
              </section>
              <section class="table__group">
                <div class="table__head">
                  <div class="table__block">
                    <h3 class="table__heading">HubSpot構築フェーズ</h3>
                ...
                <div class="table__body">
                  <ul class="table__list">
                    <li class="table__item">
                      ...
                      <p class="table__text">HubSpotの活用を行い、定例MTGでユーザーからの課題や要望に沿って、伴走支援いたします。スポットでの改修依頼はコミュニケーションツールを介して、簡単に依頼いただけます。</p>
                    </li>
                    <li class="table__item">
                      <p class="table__label">PDCA改善</p>
                      <p class="table__text">経営指標、営業戦略などを踏まえて、HubSpot活用強化の観点から今後の構築や改善計画、アプリケーション導入のご提案を実施いたします。</p>
                    </li>
                  </ul>
                </div>
              </section>
      ...
      <section class="service-hubspot-differ">
        <div class="service-hubspot-heading">
          <h2 class="service-hubspot-heading__main"><span>他社との違い</span></h2>
        </div>
        <div class="service-hubspot-differ__inner service-hubspot-inner">
                  ...
                  <div class="table__body">
                    <ul class="table__list">
                      <li class="table__item">
                        ...
                        <span class="table__text">製造・小売業をはじめ、多くの業界でHubSpot支援を行なっている経験が豊富なプロが対応。</span>
                      </li>
                      <li class="table__item">
      ...
      <section class="service-hubspot-ceo">
        <div class="service-hubspot-ceo__inner service-hubspot-inner">
          <div class="service-hubspot-ceo__box js-scroll-anime" data-anime="fadeInUp">
            <div class="service-hubspot-heading">
              <h2 class="service-hubspot-heading__main"><span>HubSpot導入支援/運用代行<br class="utils-block-hidden-pc">サービスの担当者ご紹介</span></h2>
            </div>
            <div class="content">
      ...
      <div class="service-hubspot-howto service-hubspot-howto001">
        <div class="service-hubspot-howto__inner service-hubspot-inner">
          <div class="service-hubspot-heading-box">
            <p class="service-hubspot-heading-box__main">HubSpotの外部業者選定を<br class="utils-block-hidden-pc">誤ってしまうと<br class="utils-block-hidden-mobile"><span>労働生産性の低下</span>を<br class="utils-block-hidden-pc">引き起こす要因になります。</p>
            <p class="service-hubspot-heading-box__sub">HubSpotは企業基盤となる仕組みとなります。<br class="utils-block-hidden-mobile">そのため、導入する企業は増加傾向にありますが、<br class="utils-block-hidden-mobile">安易な選択で外部業者の選定や導入を行うと<br class="utils-block-hidden-mobile">運用・活用観点で課題が生じ、<br class="utils-block-hidden-mobile">場合によっては活用できない状況にもつながります。</p>
          </div>
          <ul class="list list--ng js-scroll-anime" data-anime="fadeInUp">
            ...
            <li class="list__item">
              <section class="content">
                <p class="content__head">課題となるサイン</p>
                <div class="content__body">
                  <p class="content__text">初期構築は終わっているが<br class="utils-block-hidden-mobile">HubSpot人材が不足し、<br class="utils-block-hidden-mobile">推進できない</p>
                </div>
              </section>
            </li>
            <li class="list__item">
          ...
          <ul class="list list--ok list--before-arrow js-scroll-anime" data-anime="fadeInUp">
            ...
            <li class="list__item">
              <section class="content">
                ...
                <div class="content__body">
                  <p class="content__text">HubSpotのプロが<br class="utils-block-hidden-mobile">構築するため、稼働・定着まで最短で実現</p>
                </div>
              </section>
            </li>
            <li class="list__item">
          ...
          <div class="solution js-scroll-anime" data-anime="fadeInUp">
            ...
            <p class="solution__main"><strong>HubSpotの導入・運用</strong><br class="utils-block-hidden-pc">を代行します！！</p>
          </div>
        </div>
      </div>

      <section class="service-hubspot-qa">
        <div class="service-hubspot-qa__inner service-hubspot-inner">
          <div class="service-hubspot-heading">
            <p class="service-hubspot-heading__sub">HubSpot導入支援/運用代行<br class="utils-block-hidden-pc">サービスでの</p>
            <h2 class="service-hubspot-heading__main"><span>よくある質問</span></h2>
          </div>
          <?php
          // リストデータを配列で管理
          $list_items = [
            [
              'question' => 'HubSpot導入前だけでなく、導入後からでも相談可能ですか？',
              'answer' => '対応可能です。現状と課題をお伺いした上で最適なプランをご提案させていただきます。'
            ],
            [
              'question' => 'HubSpot導入後の運用や保守、人財育成もお願いできますか？',
              'answer' => '対応可能です。運用や保守、人財育成など、内容によって金額が異なるため、別途御見積りとさせていただきます。'
            ],
            [
              'question' => 'HubSpotをはじめ、顧客管理の導入前から相談することは可能ですか？',
            ...
            [
              ...
              'answer' => '対応可能です。HubSpotの運用代行を行う上で、課題感や最適なプランがある場合はご提案する場合もございます。'
            ],
            [
              'question' => '構築期間はどのくらいかかりますか？',
              'answer' => '一般的なHubSpotの構築期間は4ヶ月〜となります。内容によって期間は変動します。'
            ],
            [
              'question' => 'HubSpotのライセンス選定も可能ですか？',
                  ...
                  <div class="content__body <?php echo $index === 0 ? 'utils-active' : ''; ?>">
                    <div class="content__inner">
                      ...
                      <div class="content__btn" style="margin-top:38px;">
                        <a class="service-hubspot-btn service-hubspot-btn--black" href="#contact">無料で相談する</a>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="section contact" id="contact" data-scroll-adjust-pc="60" data-scroll-adjust-sp="30">
        <div class="service-hubspot-heading">
          <h2 class="service-hubspot-heading__main"><span>お問い合わせ</span></h2>
        </div>
        <div class="inner-s">
