...
//        sprintf('%s/assets/img/3x2.webp', get_stylesheet_directory_uri());
    ...
    <div class="p-news-single">
        <div class="cm-block-header">
            <div class="l-container">
                <div class="cm-block-header__title">
                    <p class="cm-block-header__en">Voice</p>
                    <p class="cm-block-header__ja">お客様成功事例</p>
                </div>
        ...
        <div class="p-news-single__index"><a class="c-btn-txt" href="<?= home_url() ?>/news/"><span class="js-clone">Voice Index</span></a></div>
        <?php wp_reset_query(); ?>
    </div>
<?php endwhile; endif; ?>
<?php get_footer(); ?>